          ...
          <div className="mx-auto max-w-4xl space-y-12">
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                Architected and delivered organization-based access control, role management, and time-entry billing system for enterprise clients.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Improved internal operations</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
