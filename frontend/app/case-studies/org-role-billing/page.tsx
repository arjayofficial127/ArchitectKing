...
export default function OrgRoleBillingCaseStudy() {
  return (
        ...
        <section className="relative mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="mx-auto max-w-4xl">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
              Organization & Role Management + Billing System
            </h1>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl space-y-12">
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                I designed and delivered organization-based access control, role management, time entry, and billing for client teams.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                  ...
                  <span>Org hierarchy modeling</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Time tracking engine</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Billing calculations</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
            ...
            {/* Backend */}
            <div>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Backend</h2>
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Secure role resolution</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Multi-tenant logic</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Put access, time entry, and billing into one consistent workflow</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Automated billing workflows</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Reduced access errors</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['.NET Core', 'SQL', 'React', 'Azure'].map((tech) => (
                  <span
                    key={tech}
