...
export default function LearningPlatformCaseStudy() {
  return (
          ...
          <div className="mx-auto max-w-4xl space-y-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                  ...
                  <span>Multi-role access (Admin, Instructor, Employee)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Large video handling</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Performance at scale</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Module progression engine</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Video engine integration</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Certificate PDF generator</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Backend architecture & database design</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['.NET Core', 'Node', 'SQL', 'React', 'Azure'].map((tech) => (
                  <span
                    key={tech}
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Reduced manual training tracking</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
                  <span>Automated certification issuance</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#F4C430] mr-2 mt-1">•</span>
