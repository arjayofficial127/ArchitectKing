...
export function ProofFoldCloser() {
  return (
    <>
      ...
      <section className="relative w-full mx-auto max-w-7xl px-4 sm:px-6 py-16 md:py-24 bg-slate-50/50 overflow-x-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 text-left">
        ...
        {/* 2x2 capability grid (mobile-friendly) */}
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 border border-slate-300/80 rounded-md bg-white text-slate-700 flex flex-col h-full shadow-sm hover:shadow-xl transition-all duration-200 w-full mx-auto md:mx-0 whitespace-normal">
            <div className="flex items-start gap-3">
              <span className="text-[#F4C430] mt-1">✔</span>
              <h4 className="text-lg md:text-xl font-bold text-slate-900">RBAC & Multi-Tenant Access</h4>
            </div>
          ...
          <div className="p-6 border border-slate-300/80 rounded-md bg-white text-slate-700 flex flex-col h-full shadow-sm hover:shadow-xl transition-all duration-200 w-full mx-auto md:mx-0 whitespace-normal">
            <div className="flex items-start gap-3">
              <span className="text-[#F4C430] mt-1">✔</span>
              <h4 className="text-lg md:text-xl font-bold text-slate-900">Platform Integration & Architecture</h4>
            </div>
          ...
          <div className="p-6 border border-slate-300/80 rounded-md bg-white text-slate-700 flex flex-col h-full shadow-sm hover:shadow-xl transition-all duration-200 w-full mx-auto md:mx-0 whitespace-normal">
            <div className="flex items-start gap-3">
              <span className="text-[#F4C430] mt-1">✔</span>
              <h4 className="text-lg md:text-xl font-bold text-slate-900">Workflows & Real-time Reporting</h4>
            </div>
          ...
          <div className="p-6 border border-slate-300/80 rounded-md bg-white text-slate-700 flex flex-col h-full shadow-sm hover:shadow-xl transition-all duration-200 w-full mx-auto md:mx-0 whitespace-normal">
            <div className="flex items-start gap-3">
              <span className="text-[#F4C430] mt-1">✔</span>
              <h4 className="text-lg md:text-xl font-bold text-slate-900">Authentication & Identity</h4>
            </div>
