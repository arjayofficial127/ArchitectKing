...
export function BiWeekView({ startDate, events, onEventClick, onSlotClick, onEventTimesChange, onEventDuplicate, onEventToggleOpenSlot, onEventDelete, openSlotMode, timezone }: BiWeekViewProps) {
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent) => {
      ...
      const dayWidth = (gridRef.current.scrollWidth - GUTTER_PX) / 14;
  ...
  const handleMouseUp = useCallback(() => {
    ...
    setDragStart(null);
    setDragEnd(null);
  }, [isDragging, dragStart, dragEnd, biWeekDays, timezone, onSlotClick, interactions]);
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      <div className="border-b border-gray-200 overflow-x-auto">
        <div className="grid" style={{ gridTemplateColumns: '4rem repeat(14, minmax(0, 1fr))', minWidth: '1400px' }}>
                ...
                {dayEvents.map((event, eventIndex) => {
                  ...
                  return (
                    <div
                      ...
                      className="absolute rounded px-1 py-0.5 text-xs cursor-grab active:cursor-grabbing select-none hover:shadow-md transition-shadow border-l-2 overflow-hidden"
                      style={{
                        ...position,
                        left: `${offset}%`,
                        width: `${100 - offset}%`,
